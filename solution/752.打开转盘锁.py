...
class Solution:
    ...
    def bfs(self, deadends, target):
        ...
        #         return -1
        #     visited.add(item)
        step, q1, q2, visited = 0, set(), set(), set()
